...
<section >
  <div class="jumbotron home-img jumbotron-fluid">
    <div class="container">
      ...
      <p class="lead text-light text-center">Imagine Your Future</p>
    </div>
  </div>
</section>
...
<div class="container">
<img class="a_row" src="http://dream-lab.moo.jp/wp-content/uploads/2018/09/logo_header.png"alt="近未来テクノロジー" width="250px">
...
<a href="http://dream-lab.moo.jp/topics/" class="btn btn-primary btn-lg">Find your Dream!</a>
<br><br>
</div>
</section>
...
<h2>研究員の紹介</h2>
<img class="alignnone size-full wp-image-196" src="http://dream-lab.moo.jp/wp-content/uploads/kohei.png" alt="" width="90" height="92" />

<p class="fuki"><strong>こうへいくん</strong><br>
近未来テクノロジー研究所の新米。興味津々だけれど少しおっちょこちょい。
みんなと一緒に近未来テクノロジーを学ぶよ。</p><br><br>

<img src="http://dream-lab.moo.jp/wp-content/uploads/syotyo-273x300.png" alt="" width="80" height="auto" class="alignnone size-medium wp-image-201" />

<p class="fuki"><strong>所長ロボ</strong><br>
近未来テクノロジー研究所の所長。科学の話なら何でも知っている。案内をするよ</p>
<?php get_footer(); ?>
